...
int main( )
{
	...
	Expression cost1 = (1 - (d1-1)/(sqrt(pow(d1-1, 2)) + 0.00001 )) * 1/d1;
	Expression cost2 = (1 - (d2-1)/(sqrt(pow(d2-1, 2)) + 0.00001 )) * 1/d2;
	Expression cost3 = (1 - (d3-1)/(sqrt(pow(d3-1, 2)) + 0.00001 )) * 1/d3;
	Expression cost4 = (1 - (d4-1)/(sqrt(pow(d4-1, 2)) + 0.00001 )) * 1/d4;
	Expression cost5 = (1 - (d5-1)/(sqrt(pow(d5-1, 2)) + 0.00001 )) * 1/d5;*/
	...
	ocp.subjectTo(-5 <= a <= 5);
	ocp.subjectTo(-2 <= j <= 2);
	ocp.subjectTo(sqrt(pow(x-xo1, 2) + pow(y-yo1, 2)) >= r_rad+o_rad + 0.0001);
	ocp.subjectTo(sqrt(pow(x-xo2, 2) + pow(y-yo2, 2)) >= r_rad+o_rad + 0.0001);
	ocp.subjectTo(sqrt(pow(x-xo3, 2) + pow(y-yo3, 2)) >= r_rad+o_rad + 0.0001);
	ocp.subjectTo(sqrt(pow(x-xo4, 2) + pow(y-yo4, 2)) >= r_rad+o_rad + 0.0001);
	ocp.subjectTo(sqrt(pow(x-xo5, 2) + pow(y-yo5, 2)) >= r_rad+o_rad + 0.0001);
