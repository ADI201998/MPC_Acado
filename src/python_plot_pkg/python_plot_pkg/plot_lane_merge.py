...
class PlotPath(Node):
    ...
    def __init__(self):
        ...
        self.obs_pos = np.array([[20,-2],[25,-2],[30,-2],[-100,-2.0],[-150,-2.0]])#
    ...
    def plot_path(self, twist, path):
        ...
        plt.plot([-2000000,2000000], [0,0], linestyle='--', color='black')
        plt.plot([-2000000,300], [-8,-8], 'black')
        plt.plot([-2000000,2000000], [4,4], 'black')
