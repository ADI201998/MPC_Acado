            ...
            if self.Gotit or self.flag:
                ...
                if self.flag == 0:
                    ...
                    for e, r in zip(ells, rect):
                        ...
                        ego_circle1 = plt.Circle((self.other_vehicles[mm][0]-2*np.cos(0.0), self.other_vehicles[mm][1])-2*np.sin(0.0), 1.0, color='r')
                        ego_circle2 = plt.Circle((self.other_vehicles[mm][0], self.other_vehicles[mm][1]), 1.0, color='r')
                        ego_circle3 = plt.Circle((self.other_vehicles[mm][0]+2*np.cos(0.0), self.other_vehicles[mm][1]+2*np.sin(0.0)), 1.0, color='r')
                    ...
                    for e, r in zip(rob, rect):
                        ...
                        ego_circle1 = plt.Circle((self.obs[0][0]-2*np.cos(self.psi), self.obs[0][1]-2*np.sin(self.psi)), 1.0, color='b')
                        ego_circle2 = plt.Circle((self.obs[0][0], self.obs[0][1]), 1.0, color='b')
                        ego_circle3 = plt.Circle((self.obs[0][0]+2*np.cos(self.psi), self.obs[0][1]+2*np.sin(self.psi)), 1.0, color='b')
                        plt.gca().add_patch(ego_circle1)
                        plt.gca().add_patch(ego_circle2)
                        plt.gca().add_patch(ego_circle3)
