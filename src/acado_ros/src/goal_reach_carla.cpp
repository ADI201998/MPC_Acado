...
GoalReach::GoalReach(): Node("acado_goal_reach_srv"), count_(0)
{
    ...
    for (i = 0; i < (N + 1); ++i)  
    {
        acadoVariables.x[ NX * i + 0 ] = -230.0; // x
        acadoVariables.x[ NX * i + 1 ] = -95.0; // y
    ...
    for (i = 0; i < N; ++i)  
    {
        acadoVariables.y[ NY * i + 0 ] = -30; // xg
        acadoVariables.y[ NY * i + 1 ] = -95.0;	// yg	
    ...
    acadoVariables.yN[0] = -30.0;
    acadoVariables.yN[1] = -95.0; // theta
    ...
    for (int i = 0; i < (N + 1); ++i)
    {
        ...
        acadoVariables.od[i * NOD + 6] = 18.0;
        acadoVariables.od[i * NOD + 7] = -4.0;
        acadoVariables.od[i * NOD + 8] = 18.0;
        acadoVariables.od[i * NOD + 9] = -4.0;

        acadoVariables.od[i * NOD + 10] = 0;
        acadoVariables.od[i * NOD + 11] = 1;
        acadoVariables.od[i * NOD + 12] = 95;
    }
    for (int i = 0; i < N; i++)
    {
    ...
    acadoVariables.x0[ 0 ] = -230.0; // x
    acadoVariables.x0[ 1 ] = -95.0; // y
