...
GoalReach::GoalReach(): Node("acado_circle_lane_srv"), count_(0)
{
    ...
    acadoVariables.WN[(NYN+1)*0] = 2.5*1e6;
	acadoVariables.WN[(NYN+1)*1] = 2.5*1e6;
    ...
    for (int i = 0; i < (N + 1); ++i)
    {
        ...
        if (i >= lane_cons.poses[0].position.x)
        {
            ...
            if(lane_cons.poses[0].position.y == 0.0)
            {
                ...
                //acadoVariables.W[NY*NY*i + (NY+1)*3] = 500;
                acadoVariables.W[NY*NY*i + (NY+1)*3] = 1*1e2;        //a
                acadoVariables.W[NY*NY*i + (NY+1)*4] = 1*1e4;        //j
                //acadoVariables.W[NY*NY*i + (NY+1)*5] = 0.0;         //lane_dist
                acadoVariables.W[NY*NY*i + (NY+1)*5] = 3*1e4;
                acadoVariables.W[NY*NY*i + (NY+1)*6] = 3*1e4;
                acadoVariables.W[NY*NY*i + (NY+1)*7] = 3*1e4;
                acadoVariables.W[NY*NY*i + (NY+1)*8] = 3*1e4;
                acadoVariables.W[NY*NY*i + (NY+1)*9] = 3*1e4;
                acadoVariables.W[NY*NY*i + (NY+1)*10] = 3*1e4;
                acadoVariables.W[NY*NY*i + (NY+1)*11] = 3*1e4;
                acadoVariables.W[NY*NY*i + (NY+1)*12] = 3*1e4;
                acadoVariables.W[NY*NY*i + (NY+1)*13] = 3*1e4;
                acadoVariables.W[NY*NY*i + (NY+1)*14] = 3*1e4;
                acadoVariables.W[NY*NY*i + (NY+1)*15] = 1.0;
                acadoVariables.W[NY*NY*i + (NY+1)*16] = 0.0;
                acadoVariables.WN[(NYN+1)*0] = 1*1e3;
                acadoVariables.WN[(NYN+1)*1] = 1*1e3;
                acadoVariables.WN[(NYN+1)*2] = 5*1e5;
            }
            else
            {
                ...
                acadoVariables.W[NY*NY*i + (NY+1)*4] = 1*1e2;        //j
                //acadoVariables.W[NY*NY*i + (NY+1)*5] = 0.0;         //lane_dist
                acadoVariables.W[NY*NY*i + (NY+1)*5] = 8.0*1e3;
                acadoVariables.W[NY*NY*i + (NY+1)*6] = 8.0*1e3;
                acadoVariables.W[NY*NY*i + (NY+1)*7] = 8.0*1e3;
                acadoVariables.W[NY*NY*i + (NY+1)*8] = 8.0*1e3;
                acadoVariables.W[NY*NY*i + (NY+1)*9] = 8.0*1e3;
                acadoVariables.W[NY*NY*i + (NY+1)*10] = 8.0*1e3;
                acadoVariables.W[NY*NY*i + (NY+1)*11] = 8.0*1e3;
                acadoVariables.W[NY*NY*i + (NY+1)*12] = 8.0*1e3;
                acadoVariables.W[NY*NY*i + (NY+1)*13] = 8.0*1e3;
                acadoVariables.W[NY*NY*i + (NY+1)*14] = 8.0*1e3;
