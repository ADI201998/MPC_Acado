...
GoalReach::GoalReach(): Node("acado_goal_reach_srv"), count_(0)
{
    ...
    for (int i = 0; i < N; i++)
    {
        acadoVariables.W[NY*NY*i + (NY+1)*0] = 0.005;
        acadoVariables.W[NY*NY*i + (NY+1)*1] = 0.005;
        ...
        acadoVariables.W[NY*NY*i + (NY+1)*5] = 5;
    ...
    acadoVariables.WN[(NYN+1)*0] = 1/10000;
	acadoVariables.WN[(NYN+1)*1] = 1/10000;
